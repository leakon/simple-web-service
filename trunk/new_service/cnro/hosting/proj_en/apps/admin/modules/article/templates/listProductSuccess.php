...
<form name="theform" id="searchForm" method="get" action="<?php echo url_for_admin('article/listProduct') ?>">
...
<tr>
	...
	<td>
		...
		<a href="<?php echo url_for_admin('article/listProduct') ?>">重新搜索</a>
	</td>
</tr>
...
?>
	...
	<td><a href="<?php echo url_for_admin('article/editProduct?id=' . $val['id']) ?>">编辑</a></td>
