...
<ul id="menu_01">
<li><a target="fright" href="<?php echo url_for_2('camera/index') ?>&action=index">品牌管理</a></li>
...
<ul id="menu_02">
<li><a target="fright" href="<?php echo url_for_2('lens/index') ?>&action=index">品牌管理</a></li>
<li><a target="fright" href="<?php echo url_for_2('caliber/index') ?>&action=index">口径管理</a></li>
<li><a target="fright" href="<?php echo url_for_2('lens/model') ?>">型号管理</a></li>
</ul>

<h1 onclick="menu_set('menu_03')"><a>脚架管理</a></h1>
<ul id="menu_03">
<li><a target="fright" href="<?php echo url_for_2('stand/index') ?>&action=index">品牌管理</a></li>
<li><a target="fright" href="<?php echo url_for_2('stand/model') ?>">型号管理</a></li>
</ul>

<h1 onclick="menu_set('menu_04')"><a>摄影包管理</a></h1>
<ul id="menu_04">
<li><a target="fright" href="<?php echo url_for_2('bag/index') ?>&action=index">品牌管理</a></li>
...
<ul id="menu_05">
<li><a target="fright" href="<?php echo url_for_2('filter/index') ?>&action=index">品牌管理</a></li>
<li><a target="fright" href="<?php echo url_for_2('filter/model') ?>">型号管理</a></li>
</ul>

<h1 onclick="menu_set('menu_06')"><a>云台管理</a></h1>
<ul id="menu_06">
<li><a target="fright" href="<?php echo url_for_2('holder/index') ?>&action=index">品牌管理</a></li>
<li><a target="fright" href="<?php echo url_for_2('holder/model') ?>">型号管理</a></li>
</ul>

<h1 onclick="menu_set('menu_07')" class="h1"><a>系统管理</a></h1>
<ul id="menu_07">
<li><a target="fright" href="<?php echo url_for_2('tag/index') ?>&action=index">标签管理</a></li>
<li><a target="fright" href="<?php echo url_for_2('price/index') ?>&action=index">价格区间</a></li>
