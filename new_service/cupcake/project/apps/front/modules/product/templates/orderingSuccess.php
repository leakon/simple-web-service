...
?>
      ...
      <div class="list">
        <table width="296" height="110" border="0" cellspacing="0">
          <tr>
            <td width="20" align="center"><input type="checkbox" name="product_checked[<?php echo $item['id'] ?>]" value="1" class="" id="" />
            </td>
		...
		<?php echo $item['detail'] ?>
            ...
            <td width="28"><input type="text" name="product_qty[<?php echo $item['id'] ?>]" value="1" style="width:16px;" class="product_qty" />
            </td>
          </tr>
        </table>
      </div>
