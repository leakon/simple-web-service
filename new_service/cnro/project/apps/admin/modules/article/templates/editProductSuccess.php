...
<input type="hidden" name="type" value="<?php echo CnroConstant::ARTICLE_TYPE_PRODUCT ?>" />
<input type="hidden" name="range" value="<?php echo $articleItem->range ?>" />
...
?>
		...
		var objConf		= {
						...
						'category_type':	'<?php echo CnroConstant::ARTICLE_TYPE_PRODUCT ?>',
						'form_id':		'searchForm',
