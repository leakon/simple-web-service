...
<form name="theform" id="searchForm" method="get" action="<?php echo url_for_admin('article/listRange') ?>">
...
<tr>
	...
	<td>
		...
		<a href="<?php echo url_for_admin('article/listRange') ?>">重新搜索</a>
	</td>
</tr>
...
?>
	...
	<td><a href="<?php echo url_for_admin('article/editRange?id=' . $val['id']) ?>">编辑</a></td>
